...
public class EnemyElephant extends EnemyBase {
     ...
     * @constructor
     */
    public function EnemyElephant() {
        _sprite = new Elephant_mc();
    }
    ...
    override public function free():void {
        if (!_isFree) {
            ...
            _universe.cacheEnemyElephant.set(this);
            super.free();
            _isFree = true;
        }
    }
